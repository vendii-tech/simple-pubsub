...
✅ All baseline requirements have been achieved
✅ (i) using a repository for storing Machines and injecting them into events subscriber
✅ (ii) using advanced functional concepts like an Maybe
✅ Additional Events implemented to simulate a real cycle - machine creation, maintenance and removal
✅ Using ESLint and Prettier for consistent code formatting. This ensures ease of merging when working in teams.
✅ Jest unit and integration testing for every subscriber and integration with Pubsub service
✅ Clear type and interface declaration to reduce brain hemorrhage while programming with Typescript
✅ UUID implementation for MachineSaleEvent, MachineRefillEvent (Half a brain hemorrhage from trying to setup Jest with Typescript and ESM to import UUID. Used Crypto native instead)

📝 AI has been used to support development, namely in writing tests
