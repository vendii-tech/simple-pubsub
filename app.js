...
var IService = /** @class */ (function () {
    ...
    IService.prototype.publish = function (event) {
        if (this.subHandlers.has(event.type())) {
            this.subHandlers.get(event.type()).handle(event);
        }
    };
    IService.prototype.subscribe = function (type, handler) {
